...
const VideoPlayer = ({ streamUrl, isFullscreen, tg, onPlayerReady }) => {
  ...
  }, [streamUrl, isFullscreen, tg, onPlayerReady]);

  return <div ref={artRef} id="art-player" className="my-4"></div>;
};
